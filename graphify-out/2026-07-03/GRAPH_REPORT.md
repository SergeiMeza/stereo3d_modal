...
## Corpus Check
- 381 files · ~493,066 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3652 nodes · 7363 edges · 343 communities (195 shown, 148 thin omitted)
- Extraction: 94% EXTRACTED · 6% INFERRED · 0% AMBIGUOUS · INFERRED: 430 edges (avg confidence: 0.68)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `2603022e`
- Run `git rev-parse HEAD` and compare to check if the graph is stale.
- Run `graphify update .` after code changes (no API cost).

## Community Hubs (Navigation)
- [[_COMMUNITY_Web App Pages & Layout|Web App Pages & Layout]]
- [[_COMMUNITY_API Service Billing & Job Orchestration|API Service: Billing & Job Orchestration]]
- [[_COMMUNITY_Storage & Analyze Pipeline|Storage & Analyze Pipeline]]
- [[_COMMUNITY_Debug Logging & Error Handling|Debug Logging & Error Handling]]
- [[_COMMUNITY_Scene Overrides & Stereo Passthrough|Scene Overrides & Stereo Passthrough]]
- [[_COMMUNITY_Web Project Cards & UI Kit|Web Project Cards & UI Kit]]
- [[_COMMUNITY_Gateway Firestore Store & Models|Gateway Firestore Store & Models]]
- [[_COMMUNITY_Web Step Panel Tests|Web Step Panel Tests]]
- [[_COMMUNITY_M2SVid Encoders & Embedders|M2SVid Encoders & Embedders]]
- [[_COMMUNITY_Web Steps Depth Panel & Scene Picker|Web Steps: Depth Panel & Scene Picker]]
- [[_COMMUNITY_Web Steps Conversion Tracker & Downloads|Web Steps: Conversion Tracker & Downloads]]
- [[_COMMUNITY_Video Depth Anything Motion Module|Video Depth Anything Motion Module]]
- [[_COMMUNITY_Slack Notify & Watchdog|Slack Notify & Watchdog]]
- [[_COMMUNITY_Web Steps Deliver Panel & Output Options|Web Steps: Deliver Panel & Output Options]]
- [[_COMMUNITY_M2SVid Diffusion UNet Blocks|M2SVid Diffusion UNet Blocks]]
- [[_COMMUNITY_Benchmarks & AB Test Docs|Benchmarks & A/B Test Docs]]
- [[_COMMUNITY_Gateway Pricing & Quotes|Gateway Pricing & Quotes]]
- [[_COMMUNITY_M2SVid Attention Layers|M2SVid Attention Layers]]
- [[_COMMUNITY_Scene Cut Mapping & FPS Resampling|Scene Cut Mapping & FPS Resampling]]
- [[_COMMUNITY_ProPainter Canny Kernels|ProPainter Canny Kernels]]
- [[_COMMUNITY_M2SVid Temporal Autoencoder|M2SVid Temporal Autoencoder]]
- [[_COMMUNITY_ProPainter RAFT Utils|ProPainter RAFT Utils]]
- [[_COMMUNITY_M2SVid UNet Attention Pooling|M2SVid UNet Attention Pooling]]
- [[_COMMUNITY_Gateway Projects API Tests|Gateway Projects API Tests]]
- [[_COMMUNITY_Gateway Stripe Integration|Gateway Stripe Integration]]
- [[_COMMUNITY_M2SVid Autoencoding Regularizers|M2SVid Autoencoding Regularizers]]
- [[_COMMUNITY_ProPainter RAFT Datasets|ProPainter RAFT Datasets]]
- [[_COMMUNITY_Model Weights Management|Model Weights Management]]
- [[_COMMUNITY_M2SVid Diffusion VAE Model|M2SVid Diffusion VAE Model]]
- [[_COMMUNITY_Cost Reporting|Cost Reporting]]
- [[_COMMUNITY_App Stages Video|App Stages Video]]
- [[_COMMUNITY_App Stages Depth Pro|App Stages Depth Pro]]
- [[_COMMUNITY_Web Src Components|Web Src Components]]
- [[_COMMUNITY_App Stages Video (2)|App Stages Video (2)]]
- [[_COMMUNITY_App Vendor ProPainter|App Vendor ProPainter]]
- [[_COMMUNITY_App Vendor M2SVid|App Vendor M2SVid]]
- [[_COMMUNITY_App Vendor Video Depth Anything|App Vendor Video Depth Anything]]
- [[_COMMUNITY_App Vendor ProPainter (2)|App Vendor ProPainter (2)]]
- [[_COMMUNITY_Web Src Lib|Web Src Lib]]
- [[_COMMUNITY_Gateway Internal Api|Gateway Internal Api]]
- [[_COMMUNITY_Gateway Internal Httpx|Gateway Internal Httpx]]
- [[_COMMUNITY_App Stages Video (3)|App Stages Video (3)]]
- [[_COMMUNITY_App Vendor M2SVid (2)|App Vendor M2SVid (2)]]
- [[_COMMUNITY_Docs Architecture Architecture|Docs Architecture Architecture]]
- [[_COMMUNITY_Previews Full Batch|Previews Full Batch]]
- [[_COMMUNITY_Gateway Internal Api (2)|Gateway Internal Api (2)]]
- [[_COMMUNITY_App Api Main|App Api Main]]
- [[_COMMUNITY_App Vendor ProPainter (3)|App Vendor ProPainter (3)]]
- [[_COMMUNITY_App Vendor ProPainter (4)|App Vendor ProPainter (4)]]
- [[_COMMUNITY_Gateway Internal Api (3)|Gateway Internal Api (3)]]
- [[_COMMUNITY_App Common Reuse|App Common Reuse]]
- [[_COMMUNITY_App Vendor M2SVid (3)|App Vendor M2SVid (3)]]
- [[_COMMUNITY_App Vendor M2SVid (4)|App Vendor M2SVid (4)]]
- [[_COMMUNITY_App Vendor ProPainter (5)|App Vendor ProPainter (5)]]
- [[_COMMUNITY_App Vendor ProPainter (6)|App Vendor ProPainter (6)]]
- [[_COMMUNITY_Web Components Aliases|Web Components Aliases]]
- [[_COMMUNITY_Web Src Components (2)|Web Src Components (2)]]
- [[_COMMUNITY_Web Src Components (3)|Web Src Components (3)]]
- [[_COMMUNITY_Web Src Components (4)|Web Src Components (4)]]
- [[_COMMUNITY_App Vendor ProPainter (7)|App Vendor ProPainter (7)]]
- [[_COMMUNITY_App Vendor M2SVid (5)|App Vendor M2SVid (5)]]
- [[_COMMUNITY_App Vendor Video Depth Anything (2)|App Vendor Video Depth Anything (2)]]
- [[_COMMUNITY_App Vendor Video Depth Anything (3)|App Vendor Video Depth Anything (3)]]
- [[_COMMUNITY_Web Tsconfig Compileroptions|Web Tsconfig Compileroptions]]
- [[_COMMUNITY_App Vendor M2SVid (6)|App Vendor M2SVid (6)]]
- [[_COMMUNITY_Tests Test Reuse|Tests Test Reuse]]
- [[_COMMUNITY_App Vendor M2SVid (7)|App Vendor M2SVid (7)]]
- [[_COMMUNITY_App Vendor M2SVid (8)|App Vendor M2SVid (8)]]
- [[_COMMUNITY_App Vendor ProPainter (8)|App Vendor ProPainter (8)]]
- [[_COMMUNITY_App Vendor Video Depth Anything (4)|App Vendor Video Depth Anything (4)]]
- [[_COMMUNITY_Web Src Screens|Web Src Screens]]
- [[_COMMUNITY_App Stages M2SVid|App Stages M2SVid]]
- [[_COMMUNITY_App Vendor ProPainter (9)|App Vendor ProPainter (9)]]
- [[_COMMUNITY_App Stages Image|App Stages Image]]
- [[_COMMUNITY_App Vendor Forward Warp|App Vendor Forward Warp]]
- [[_COMMUNITY_App Vendor M2SVid (9)|App Vendor M2SVid (9)]]
- [[_COMMUNITY_App Vendor M2SVid (10)|App Vendor M2SVid (10)]]
- [[_COMMUNITY_App Vendor M2SVid (11)|App Vendor M2SVid (11)]]
- [[_COMMUNITY_App Vendor Video Depth Anything (5)|App Vendor Video Depth Anything (5)]]
- [[_COMMUNITY_App Vendor M2SVid (12)|App Vendor M2SVid (12)]]
- [[_COMMUNITY_App Vendor Forward Warp (2)|App Vendor Forward Warp (2)]]
- [[_COMMUNITY_App Vendor M2SVid (13)|App Vendor M2SVid (13)]]
- [[_COMMUNITY_App Vendor ProPainter (10)|App Vendor ProPainter (10)]]
- [[_COMMUNITY_App Vendor Video Depth Anything (6)|App Vendor Video Depth Anything (6)]]
- [[_COMMUNITY_Docs Depth Script|Docs Depth Script]]
- [[_COMMUNITY_Web Package Dependencies|Web Package Dependencies]]
- [[_COMMUNITY_Web Package Devdependencies|Web Package Devdependencies]]
- [[_COMMUNITY_Web Src Components (5)|Web Src Components (5)]]
- [[_COMMUNITY_Web Src Lib (2)|Web Src Lib (2)]]
- [[_COMMUNITY_App Vendor ProPainter (11)|App Vendor ProPainter (11)]]
- [[_COMMUNITY_App Vendor Forward Warp (3)|App Vendor Forward Warp (3)]]
- [[_COMMUNITY_App Vendor M2SVid (14)|App Vendor M2SVid (14)]]
- [[_COMMUNITY_App Vendor M2SVid (15)|App Vendor M2SVid (15)]]
- [[_COMMUNITY_App Vendor Forward Warp (4)|App Vendor Forward Warp (4)]]
- [[_COMMUNITY_App Vendor M2SVid (16)|App Vendor M2SVid (16)]]
- [[_COMMUNITY_App Vendor ProPainter (12)|App Vendor ProPainter (12)]]
- [[_COMMUNITY_App Vendor ProPainter (13)|App Vendor ProPainter (13)]]
- [[_COMMUNITY_Docs Api Frame|Docs Api Frame]]
- [[_COMMUNITY_Web Package Scripts|Web Package Scripts]]
- [[_COMMUNITY_Web Src Components (6)|Web Src Components (6)]]
- [[_COMMUNITY_Gateway Internal Api (4)|Gateway Internal Api (4)]]
- [[_COMMUNITY_Tests Test Depth|Tests Test Depth]]
- [[_COMMUNITY_App Vendor ProPainter (14)|App Vendor ProPainter (14)]]
- [[_COMMUNITY_App Vendor ProPainter (15)|App Vendor ProPainter (15)]]
- [[_COMMUNITY_App Vendor ProPainter (16)|App Vendor ProPainter (16)]]
- [[_COMMUNITY_Docs Api Cost|Docs Api Cost]]
- [[_COMMUNITY_Gateway Internal Gcsx|Gateway Internal Gcsx]]
...
- [[_COMMUNITY_App Stages Vexu|App Stages Vexu]]
- [[_COMMUNITY_App Vendor ProPainter (17)|App Vendor ProPainter (17)]]
- [[_COMMUNITY_App Vendor Video Depth Anything (8)|App Vendor Video Depth Anything (8)]]
- [[_COMMUNITY_Docs Api Post|Docs Api Post]]
- [[_COMMUNITY_Tests Test Analyze|Tests Test Analyze]]
- [[_COMMUNITY_App Stages Stereo|App Stages Stereo]]
- [[_COMMUNITY_App Vendor ProPainter (18)|App Vendor ProPainter (18)]]
- [[_COMMUNITY_Gateway Internal Httpx (2)|Gateway Internal Httpx (2)]]
- [[_COMMUNITY_Web Public Mockserviceworker|Web Public Mockserviceworker]]
- [[_COMMUNITY_Web Src Lib (4)|Web Src Lib (4)]]
- [[_COMMUNITY_App Api Schemas|App Api Schemas]]
- [[_COMMUNITY_App Stages ProPainter|App Stages ProPainter]]
- [[_COMMUNITY_App Vendor M2SVid (19)|App Vendor M2SVid (19)]]
- [[_COMMUNITY_App Vendor ProPainter (19)|App Vendor ProPainter (19)]]
- [[_COMMUNITY_App Vendor ProPainter (20)|App Vendor ProPainter (20)]]
- [[_COMMUNITY_App Vendor Video Depth Anything (9)|App Vendor Video Depth Anything (9)]]
- [[_COMMUNITY_Concept Furry Animal|Concept Furry Animal]]
- [[_COMMUNITY_Docs Api Scene|Docs Api Scene]]
- [[_COMMUNITY_Docs V7 Dualres|Docs V7 Dualres]]
- [[_COMMUNITY_Gateway Internal Gcsx (2)|Gateway Internal Gcsx (2)]]
- [[_COMMUNITY_Web Fixtures Build|Web Fixtures Build]]
- [[_COMMUNITY_Web Src Components (7)|Web Src Components (7)]]
- [[_COMMUNITY_Web Src Lib (5)|Web Src Lib (5)]]
- [[_COMMUNITY_App Stages Splat|App Stages Splat]]
- [[_COMMUNITY_App Vendor M2SVid (20)|App Vendor M2SVid (20)]]
- [[_COMMUNITY_Samples Images Letterbox|Samples Images Letterbox]]
- [[_COMMUNITY_Web Src Components (8)|Web Src Components (8)]]
- [[_COMMUNITY_App Vendor M2SVid (21)|App Vendor M2SVid (21)]]
- [[_COMMUNITY_App Vendor ProPainter (21)|App Vendor ProPainter (21)]]
- [[_COMMUNITY_Gateway Internal Probe|Gateway Internal Probe]]
- [[_COMMUNITY_App Vendor M2SVid (22)|App Vendor M2SVid (22)]]
- [[_COMMUNITY_App Vendor M2SVid (23)|App Vendor M2SVid (23)]]
- [[_COMMUNITY_App Vendor ProPainter (22)|App Vendor ProPainter (22)]]
- [[_COMMUNITY_App Vendor Video Depth Anything (10)|App Vendor Video Depth Anything (10)]]
- [[_COMMUNITY_Previews Ab V5B|Previews Ab V5B]]
- [[_COMMUNITY_Scripts Smoke Test|Scripts Smoke Test]]
- [[_COMMUNITY_Scripts Upload Samples|Scripts Upload Samples]]
- [[_COMMUNITY_Web Src Lib (6)|Web Src Lib (6)]]
- [[_COMMUNITY_App Vendor ProPainter (23)|App Vendor ProPainter (23)]]
- [[_COMMUNITY_App Vendor Video Depth Anything (11)|App Vendor Video Depth Anything (11)]]
- [[_COMMUNITY_Scripts Make Samples|Scripts Make Samples]]
- [[_COMMUNITY_Previews Ab V5B (2)|Previews Ab V5B (2)]]
- [[_COMMUNITY_App Vendor Forward Warp (5)|App Vendor Forward Warp (5)]]
- [[_COMMUNITY_App Vendor M2SVid (24)|App Vendor M2SVid (24)]]
- [[_COMMUNITY_App Vendor M2SVid (25)|App Vendor M2SVid (25)]]
- [[_COMMUNITY_App Vendor M2SVid (26)|App Vendor M2SVid (26)]]
- [[_COMMUNITY_Gateway Deploy|Gateway Deploy]]
- [[_COMMUNITY_Web Next Config|Web Next Config]]
- [[_COMMUNITY_Web Postcss Config|Web Postcss Config]]
- [[_COMMUNITY_Claude Graphify Workflow|Claude Graphify Workflow]]
- [[_COMMUNITY_Docs Api Job|Docs Api Job]]
- [[_COMMUNITY_Docs Architecture Black|Docs Architecture Black]]
- [[_COMMUNITY_Docs Architecture Job|Docs Architecture Job]]
- [[_COMMUNITY_Pkg Spatial Ai|Pkg Spatial Ai]]
- [[_COMMUNITY_Readme Storage|Readme Storage]]
- [[_COMMUNITY_Web  Vercel|Web  Vercel]]
- [[_COMMUNITY_Web Public File|Web Public File]]
- [[_COMMUNITY_Web Public Globe|Web Public Globe]]
...
- [[_COMMUNITY_instantiate_from_config|instantiate_from_config]]
- [[_COMMUNITY_DepthPanel.test.tsx|DepthPanel.test.tsx]]
- [[_COMMUNITY_distributions.py|distributions.py]]
- [[_COMMUNITY_DeliverPanel.test.tsx|DeliverPanel.test.tsx]]
- [[_COMMUNITY_depthRes.ts|depthRes.ts]]
- [[_COMMUNITY_inpaint_window|inpaint_window]]
- [[_COMMUNITY_DiagonalGaussianDistribution|DiagonalGaussianDistribution]]
- [[_COMMUNITY_EDMSampler|EDMSampler]]
- [[_COMMUNITY_Resize|Resize]]
- [[_COMMUNITY_LinearAttention|LinearAttention]]
- [[_COMMUNITY_FrozenOpenCLIPImageEmbedder|FrozenOpenCLIPImageEmbedder]]
- [[_COMMUNITY_scale_module|scale_module]]
- [[_COMMUNITY__make_infer|_make_infer]]
- [[_COMMUNITY_Slack|Slack]]
- [[_COMMUNITY_FakeExtractor|FakeExtractor]]
- [[_COMMUNITY_Config|Config]]
- [[_COMMUNITY_ClassifyChargeError|ClassifyChargeError]]
- [[_COMMUNITY_layout.tsx|layout.tsx]]
- [[_COMMUNITY_ThumbLRU|ThumbLRU]]
- [[_COMMUNITY_PreviewPlayer|PreviewPlayer]]
- [[_COMMUNITY_PreviewVideoLike|PreviewVideoLike]]
- [[_COMMUNITY_.init_weights|.init_weights]]

## God Nodes (most connected - your core abstractions)
1. `Project` - 38 edges
2. `cn()` - 37 edges
3. `useGateway()` - 34 edges
4. `WriteErr()` - 31 edges
5. `job_logger()` - 30 edges
6. `AuthedUser` - 29 edges
7. `WriteOK()` - 28 edges
8. `process_video_job()` - 27 edges
9. `Conversion` - 27 edges
10. `GatewayClient` - 26 edges
...
- `test_validate_rejects_non_bool_passthrough()` --calls--> `_validate_scene_overrides()`  [EXTRACTED]
  tests/test_passthrough.py → app/api/main.py
- `test_validate_rejects_passthrough_with_depth_knobs()` --calls--> `_validate_scene_overrides()`  [EXTRACTED]
  tests/test_passthrough.py → app/api/main.py
...
- **Video pipeline stage flow** — readme_video_pipeline, docs_architecture_depthprocessor, docs_architecture_depthsplatter, readme_propainter, docs_architecture_mvhevc [EXTRACTED 0.85]
- **Adaptive depth script v1/v2/v3 mechanisms** — docs_depth_script_classification, docs_depth_script_depth_matched_cuts, docs_depth_script_comfort_budget, docs_depth_script_fov_informed, docs_depth_script_auto_comfort [EXTRACTED 0.85]
- **Conversion billing & support trace** — gateway_design_conversion_state_machine, gateway_design_stripe, gateway_design_conversion_id, gateway_design_reconciler, gateway_readme_support_runbook [INFERRED 0.85]
- **Canine Subject 2D-to-3D Test Images** — samples_images_001_sg3xwuepybu_scene, samples_images_004_qo_pif84vxg_scene, samples_images_007_5yahl8viuvg_scene, samples_images_013_5vr_rvpfbmi_scene, samples_images_019_fliwkbbs7om_scene [EXTRACTED 1.00]
- **Furry Animals Testing Fine Edge Depth Estimation** — samples_images_001_sg3xwuepybu_scene, samples_images_004_qo_pif84vxg_scene, samples_images_007_5yahl8viuvg_scene, samples_images_013_5vr_rvpfbmi_scene, samples_images_019_fliwkbbs7om_scene [INFERRED 0.85]
- **V5b Depth-Res Sweep A/B Experiment** — previews_ab_v5b_depthsweep_cost_breakdown_per_stage_costs, previews_ab_v5b_depthsweep_cost_summary_cost_summary, previews_ab_v5b_depthsweep_ab_results_ab_results, previews_ab_v5b_depthsweep_ab_results_depth_res_quality_tradeoff [EXTRACTED 1.00]
- **ekr2 6fps Inpainter A/B (none vs M2SVid vs ProPainter)** — previews_ab_ekr2_6fps_ab_test_index_ab_test_index, previews_ab_ekr2_6fps_ab_test_inpaintings_1440p_4k_inpainting_quality, previews_compare_comparison_propainter, previews_compare_comparison_m2svid, previews_ab_ekr2_6fps_ab_test_index_auto_reuse [EXTRACTED 1.00]
- **Full-Batch v2 Multi-Video Run** — previews_full_batch_v2_readme_full_batch_v2, previews_full_batch_v2_k9_full_v2_job, previews_full_batch_v2_awkky_full_v2_job, previews_full_batch_v2_dance_full_v2_job, previews_full_batch_v2_webm2_full_v2_job [EXTRACTED 1.00]
- **full_batch_v4 Displacement-Ramp Tuning Batch** — previews_full_batch_v4_readme_full_batch_v4_overview, previews_full_batch_v4_k9_full_v4_job_record, previews_full_batch_v4_awkky_full_v4_job_record, previews_full_batch_v4_dance_full_v4_job_record, previews_full_batch_v4_webm2_full_v4_job_record [EXTRACTED 1.00]
...
## Communities (343 total, 148 thin omitted)

### Community 0 - "Web App Pages & Layout"
Cohesion: 0.23
Nodes (8): Home(), STEPS, AccountScreen(), AccountScreenProps, PROVIDER_LABELS, UserAvatar(), UserMenu(), useAuth()

### Community 1 - "API Service: Billing & Job Orchestration"
Cohesion: 0.23
Nodes (8): Service, Client, Context, Conversion, Project, RawMessage, Job, Store

### Community 2 - "Storage & Analyze Pipeline"
Cohesion: 0.07
Nodes (65): job_logger(), Logger that prefixes every line with the job id, so one job can     be traced ac, count_frames(), Exact frame count by counting packets (fast, no decode)., bucket_path(), job_cache_dir(), job_output_dir(), public_url() (+57 more)

### Community 3 - "Debug Logging & Error Handling"
Cohesion: 0.09
Nodes (33): get_logger(), _JobAdapter, Logger, Logging + tensor shape tracking.  Conventions: - module loggers via ``get_logger, Log shape/dtype/device/range of a tensor (or pass-through None)., track(), fail_fast(), Fail-fast error policy for workers.  Modal's ``retries=`` re-runs a function on (+25 more)

### Community 4 - "Scene Overrides & Stereo Passthrough"
Cohesion: 0.18
Nodes (19): Validate the ``scene_overrides`` request field (422 on any problem —     a malfo, _validate_scene_overrides(), test_validate_accepts_passthrough_only_entry(), test_validate_rejects_non_bool_passthrough(), test_validate_rejects_passthrough_with_depth_knobs(), _validate_scene_overrides: submit-time validation of scene_overrides.  Frame doc, _rejects(), test_displacement_range() (+11 more)

### Community 5 - "Web Project Cards & UI Kit"
Cohesion: 0.06
Nodes (55): AnalyzeBadge(), analyzePercent(), AnalyzeProgress(), analyzeStageLabel(), formatEtaLeft(), ProgressLike, STAGE_LABELS, Badge() (+47 more)

### Community 6 - "Gateway Firestore Store & Models"
Cohesion: 0.07
Nodes (41): DocumentIterator, DocumentSnapshot, analyzeResponse(), ProfileShot, SceneOverride, Time, Context, Conversion (+33 more)

### Community 7 - "Web Step Panel Tests"
Cohesion: 0.17
Nodes (12): replace, BillingBanner(), OnboardingScreen(), safeNext(), useBillingSetup(), RequireBilling(), BillingStatus, BillingContext (+4 more)

### Community 8 - "M2SVid Encoders & Embedders"
Cohesion: 0.05
Nodes (20): AbstractEmbModel, ClassEmbedder, ClassEmbedderForMultiCond, ConcatTimestepEmbedderND, FrozenByT5Embedder, FrozenCLIPEmbedder, FrozenCLIPT5Encoder, FrozenOpenCLIPImagePredictionEmbedder (+12 more)

### Community 9 - "Web Steps: Depth Panel & Scene Picker"
Cohesion: 0.06
Nodes (56): MuteToggle(), SPEED_CHOICES, SpeedSelect(), StepReviewProps, Button(), buttonVariants, FilmstripTimeline(), FilmstripTimelineProps (+48 more)

### Community 10 - "Web Steps: Conversion Tracker & Downloads"
Cohesion: 0.11
Nodes (14): DeliverPanelProps, PriorRunsProps, StereoPanelProps, ClientOptions, GatewayClient, TokenProvider, APIErrorBody, BillingSettleResult (+6 more)
...
Cohesion: 0.06
Nodes (43): check_worker_result(), Raise if a fail_fast worker returned an error envelope., _default_clear_chunk_progress(), _default_read_chunk_progress(), _default_read_updated_at(), _fail_all(), gather_with_heartbeat(), _modal_not_ready_exc() (+35 more)

### Community 13 - "Web Steps: Deliver Panel & Output Options"
Cohesion: 0.08
Nodes (36): FIXTURE, fixtureProject(), FPS, PROFILE, ProfileHarness(), renderPanel(), renderWithOutput(), sceneRow() (+28 more)

### Community 14 - "M2SVid Diffusion UNet Blocks"
Cohesion: 0.11
Nodes (32): Transformer block for image-like data.     First, project the input (aka embeddi, SpatialTransformer, Downsample, An upsampling layer with an optional convolution.     :param channels: channels, A downsampling layer with an optional convolution.     :param channels: channels, A residual block that can optionally change the number of channels.     :param c, The full UNet model with attention and timestep embedding.     :param in_channel, Any module where forward() takes timestep embeddings as a second argument. (+24 more)
...
Cohesion: 0.08
Nodes (17): BasicTransformerBlock, BasicTransformerSingleLayerBlock, CrossAttention, default(), exists(), FeedForward, GEGLU, MemoryEfficientCrossAttention (+9 more)

### Community 18 - "Scene Cut Mapping & FPS Resampling"
Cohesion: 0.07
Nodes (68): _annotate_source_spans(), _apply_scene_overrides(), _map_source_to_work(), SOURCE fps for the non-divisor resample mapping — NO fallback to     pre["probe", SOURCE-frame index → WORK-frame index under trim + fps decimation.      This is, Inverse of _map_source_to_work for KEPT work frames: the source     frame that w, Map user-edited ``scene_cuts`` (SOURCE-frame indices, each the first     frame o, Map ``scene_overrides`` (keyed by SOURCE-frame scene start ``first``)     onto W (+60 more)
...
Cohesion: 0.14
Nodes (10): AE3DConv, Conv2DWrapper, make_time_attn(), MemoryEfficientVideoBlock, Tensor, VideoBlock, VideoDecoder, VideoResBlock (+2 more)
...
Cohesion: 0.09
Nodes (13): AttentionBlock, AttentionPool2d, Tensor, QKVAttention, Adapted from CLIP: https://github.com/openai/CLIP/blob/main/clip/model.py, An attention block that allows spatial positions to attend to each other.     Or, A module which performs QKV attention and splits in a different order., Apply QKV attention.         :param qkv: an [N x (3 * H * C) x T] tensor of Qs, (+5 more)

### Community 23 - "Gateway Projects API Tests"
Cohesion: 0.17
Nodes (41): stepConvReq, Params, Project, T, proProject(), resolveErr(), resolveErrP(), resolveOK() (+33 more)

### Community 24 - "Gateway Stripe Integration"
Cohesion: 0.14
Nodes (11): Event, cardInfo(), New(), stripeErrCode(), PaymentIntent, PaymentMethod, CardInfo, ChargeFailure (+3 more)

### Community 25 - "M2SVid Autoencoding Regularizers"
Cohesion: 0.25
Nodes (5): AbstractRegularizer, IdentityRegularizer, measure_perplexity(), Any, Tensor
...
Cohesion: 0.07
Nodes (41): _download_url(), ensure_da2_metric(), ensure_da3(), ensure_depth_anything_v2(), ensure_depth_pro(), ensure_lama(), ensure_m2svid(), ensure_migan() (+33 more)
...
Cohesion: 0.10
Nodes (20): _costs_dir(), dumps(), _emit(), Path, Per-stage and final cost YAML written to GCS next to job outputs.  For each time, Write costs/cost.yaml (the rolled-up total) and return the summary., Serialize a dict/list/scalar tree to YAML lines. Flat-ish: enough     for cost b, Stage names contain '[', ']', ':' (e.g. video_depth[0:240]); make a     filesyst (+12 more)

### Community 30 - "App Stages Video"
Cohesion: 0.16
Nodes (9): Path, Produce a full-width SBS video. Paths are inside the cache         volume / buck, Passthrough shots ship as 2D: both eyes are the untouched source         frame —, Forward warp only — no masks, no inpainting. In "left"/"right"         mode the, Splat at source resolution, inpaint occlusions with         ProPainter at workin, Paste upscaled inpainted pixels into the dilated occlusion         holes of the, Build ``index -> (displacement, placement)`` over absolute frame     indices fro, _scene_param_lookup() (+1 more)

### Community 31 - "App Stages Depth Pro"
Cohesion: 0.10
Nodes (22): DepthProcessor, DepthResult, gray16_video_writer(), load_video_depth_model(), Encoder, Path, Tensor, Scene-aware streaming video depth estimation.  Migrated from scene_video_depth.D (+14 more)

### Community 32 - "Web Src Components"
Cohesion: 0.16
Nodes (4): FrozenOpenCLIPImageEmbedder, InceptionV3, Wrapper around the https://github.com/mseitzer/pytorch-fid inception     port wi, Uses the OpenCLIP vision transformer encoder for images
...
Cohesion: 0.12
Nodes (12): LPIPS, NetLinLayer, normalize_tensor(), Stripped version of https://github.com/richzhang/PerceptualSimilarity/tree/maste, A single linear layer which does a 1x1 conv, ScalingLayer, spatial_average(), vgg16 (+4 more)

### Community 36 - "App Vendor Video Depth Anything"
Cohesion: 0.12
Nodes (16): add_residual(), drop_add_residual_stochastic_depth(), drop_add_residual_stochastic_depth_list(), get_attn_bias_and_cat(), get_branges_scales(), NestedTensorBlock, Any, Module (+8 more)
...
Cohesion: 0.14
Nodes (11): appearance, BillingSetupContext, BillingSetupImplementation, BillingSetupPanelProps, mockBillingSetup, stripeBillingSetup, StripeSetupPanel(), completeChargeAction() (+3 more)

### Community 39 - "Gateway Internal Api"
Cohesion: 0.07
Nodes (70): AuthedUser, createConversionReq, sceneOverrideReq, main(), Service, Context, Conversion, Request (+62 more)

### Community 40 - "Gateway Internal Httpx"
Cohesion: 0.09
Nodes (21): add_timing(), Structured progress for client apps polling GET /v1/jobs/{id}.      ``band`` map, Context manager: times a stage, records it on the job, sets the     job's curren, (cpu_cores, mem_gib) reserved for a stage, by name prefix. Returns     (None, No, report_progress(), stage_resources(), stage_timer, update_job() (+13 more)

### Community 41 - "App Stages Video (3)"
Cohesion: 0.11
Nodes (15): concat_segments(), Path, Small ffmpeg/ffprobe helpers shared across stages.  Pure subprocess — no torch,, Lossless stream-copy concat of mp4 segments in order., _affine_to_ref(), _detect_scene_ranges(), _gray16_video_writer(), Path (+7 more)
...
Cohesion: 0.11
Nodes (33): CheckboxChip(), Field(), DeliverPanel(), DepthPanel(), DepthPanelProps, DepthReview(), DepthSceneGrid(), FORMAT_LABELS (+25 more)

### Community 46 - "App Api Main"
Cohesion: 0.16
Nodes (22): _cancel_call(), cancel_job(), job_status(), HTTP API.  Production endpoints     POST /v1/videos         — full 2D→3D video p, Pro step-pipeline entry (web/DESIGN.md): probe + crop detect + scene     detect, Standalone shot-profiling job: run the adaptive ShotProfiler over a     frame-ex, Stage jobs spawn a worker directly; pull its result into the job     record once, Best-effort cancel of one FunctionCall. A child may have already     finished or (+14 more)

### Community 47 - "App Vendor ProPainter (3)"
Cohesion: 0.13
...
### Community 48 - "App Vendor ProPainter (4)"
Cohesion: 0.12
...
Cohesion: 0.11
Nodes (21): M2SVidStereoWorker, Path, Produce a full-width SBS video (left = source, right =         warped + M2SVid-f, Run M2SVid on one eye. mirror=True flips inputs/outputs         horizontally (le, Splat the right eye at source resolution and FULL         displacement, run M2SV, Nearest multiple of 64, at least 64 (model dim constraint)., _round64(), _passthrough_lookup() (+13 more)
...
Cohesion: 0.09
Nodes (21): DATE_FORMAT, ProjectCard(), CONTENT_TYPES, Phase, UploadDropzone(), Dialog(), DialogContent(), DialogDescription() (+13 more)
...
Cohesion: 0.21
Nodes (13): canDecodeVideo(), createVideoFrameExtractor(), EMPTY_THUMBS, extractionSeekTime(), ExtractorFactory, noopExtractor, FPS24, NTSC (+5 more)
...
Cohesion: 0.13
Nodes (10): BlockChunk, Mlp, Module, Tensor, Module, Tensor, SwiGLUFFN, SwiGLUFFNFused (+2 more)

### Community 62 - "App Vendor Video Depth Anything (3)"
Cohesion: 0.14
Nodes (11): ConvBlock, _make_fusion_block(), FeatureFusionBlock, _make_scratch(), Init.          Args:             features (int): number of features, Forward pass.          Returns:             tensor: output, Residual convolution module., Init.          Args:             features (int): number of features (+3 more)

### Community 63 - "Web Tsconfig Compileroptions"
Cohesion: 0.10
...
Cohesion: 0.13
Nodes (21): depth_lookup_keys(), normalize_video_request(), Depth-cache candidates in LOOKUP order: the exact key first, then —     when the, Resolve the preset merge + client-facing aliases into the EFFECTIVE     request, Compute the (preprocess, depth, scenes) reuse keys for a video     request. The, reuse_request_keys(), Reuse cache-key fidelity: process_video_job and POST /v1/reuse/lookup must deriv, test_depth_key_is_preset_independent() (+13 more)
...
Cohesion: 0.07
Nodes (37): atoms, EMPTY_CHECKOUT, resetStepCheckoutState(), stepCheckoutAtom(), StepCheckoutState, CANCELABLE, ConversionTracker(), ConversionTrackerProps (+29 more)
...
Cohesion: 0.10
Nodes (23): _canonical(), compute_key(), depth_key(), depth_source_key(), lookup(), lookup_value(), peek(), preprocess_key() (+15 more)

### Community 72 - "App Vendor ProPainter (9)"
Cohesion: 0.18
...
### Community 83 - "App Vendor Video Depth Anything (6)"
Cohesion: 0.28
...
Cohesion: 0.05
Nodes (42): dependencies, class-variance-authority, clsx, jotai, lucide-react, next, radix-ui, react (+34 more)

### Community 86 - "Web Package Devdependencies"
Cohesion: 0.04
Nodes (47): FIXTURE, seedStereoDraft(), FIXTURE, FPS, RANGES, REAL_DOWNLOADS, renderPanel(), renderWithDepth() (+39 more)
...
Cohesion: 0.12
Nodes (16): dilate_mask(), get_ref_index(), inpaint_window(), ProPainterModels, ndarray, Tensor, ProPainter video inpainting runner.  Migrated from video_inpainting_model_v4 (pr, Inpaint one window of frames. Returns uint8 HWC numpy frames.      Mirrors the r (+8 more)

### Community 90 - "App Vendor Forward Warp (3)"
Cohesion: 0.19
...
Cohesion: 0.20
Nodes (3): replace, RequireAuth(), AuthProvider()
...
Cohesion: 0.21
Nodes (9): canny(), Tensor, r"""Module that finds edges of the input image and filters them using the Canny, r"""Find edges of the input image and filters them using the Canny algorithm., rgb_to_grayscale(), get_canny_nms_kernel(), get_hysteresis_kernel(), Utility function that returns 3x3 kernels for the Canny Non-maximal suppression. (+1 more)

### Community 96 - "App Vendor ProPainter (13)"
Cohesion: 0.23
...
Cohesion: 0.29
Nodes (9): create_mask(), fbConsistencyCheck(), hamming_distance(), length_sq(), padding: [[top, bottom], [left, right]], Args:         frame1: torch tensor, with shape [b * t, c, h, w]         warp_f, rgb2gray(), ternary_loss2() (+1 more)

### Community 104 - "App Vendor ProPainter (16)"
Cohesion: 0.18
...
Cohesion: 0.13
Nodes (16): DPTHead, DPTHeadTemporal, compute_scale(), compute_scale_and_shift(), compute_scale_and_shift_full(), get_interpolate_frames(), Tensor, compute_scale() (+8 more)
...
Cohesion: 0.33
Nodes (9): _box(), build_hfov(), build_vexu(), _full_box(), Apple spatial-video metadata (vexu/hfov) blob builder.  Builds the VisualSampleE, vexu box bytes. hero: "left" | "right" | None (omit hero box).      projection:, hfov box bytes (plain box, no version/flags)., Verify against the reference hex of Apple's spec layout     (iPhone-15-Pro-like (+1 more)

### Community 115 - "App Vendor ProPainter (17)"
Cohesion: 0.22
...
### Community 119 - "App Stages Stereo"
Cohesion: 0.31
Nodes (8): colorize_depth(), compose_stereo(), dubois_anaglyph(), Tensor, Stereo pair composition helpers (torch, GPU or CPU).  Output formats: - "lr" / ", Compose (1, 3, H, W) uint8 left/right frames into one frame., Dubois red-cyan anaglyph. Inputs (B, 3, H, W) float [0, 1]., (1, 1, H, W) or (H, W) float [0,1] -> (3, H, W) uint8 colormapped.

### Community 120 - "App Vendor ProPainter (18)"
Cohesion: 0.22
Nodes (4): get_root_logger(), Get the root logger.     The logger will be initialized if it has not been initi, Scan a directory to find the interested files.      Args:         dir_path (str), scandir()

### Community 121 - "Gateway Internal Httpx (2)"
Cohesion: 0.47
...
### Community 122 - "Web Public Mockserviceworker"
Cohesion: 0.42
Nodes (8): activeClientIds, getResponse(), handleRequest(), IS_MOCKED_RESPONSE, resolveMainClient(), respondWithMock(), sendToClient(), serializeRequest()

### Community 124 - "App Api Schemas"
Cohesion: 0.39
...
Cohesion: 0.27
Nodes (6): compactPlayerAtom, compactTimelineAtom, mutedAtom, playbackSpeedAtom, timelineZoomIndexAtom, ResizeObserverStub

### Community 127 - "App Vendor ProPainter (19)"
Cohesion: 0.29
Nodes (5): insert_bn(), Forward function.          Args:             x (Tensor): Input tensor with shape, Insert bn layer after each conv.      Args:         names (list): The list of la, VGG network for feature extraction.      In this implementation, we allow users, VGGFeatureExtractor

### Community 128 - "App Vendor ProPainter (20)"
Cohesion: 0.39
...
### Community 129 - "App Vendor Video Depth Anything (9)"
Cohesion: 0.29
Nodes (4): make_2tuple(), PatchEmbed, Tensor, 2D image to patch embedding: (B,C,H,W) -> (B,N,D)      Args:         img_size: I

### Community 130 - "Concept Furry Animal"
Cohesion: 0.54
...
### Community 134 - "Web Fixtures Build"
Cohesion: 0.50
Nodes (7): build_conversions(), build_project(), build_scene_profile(), load(), main(), Emit scene_profile.json from the job's adaptive profiler output     (metadata.de, save()
...
Cohesion: 0.33
Nodes (3): ForwardWarpStereo, Tensor, im:   (B, C, H, W) float         disp: (B, 1, H, W) float, signed horizontal dis

### Community 138 - "App Vendor M2SVid (20)"
Cohesion: 0.33
Nodes (3): IdentityWrapper, OpenAIWrapper, Tensor

### Community 139 - "Samples Images Letterbox"
Cohesion: 0.43
...
### Community 140 - "Web Src Components (8)"
Cohesion: 0.19
...
Cohesion: 0.32
Nodes (4): AttnBlock, MemoryEfficientAttnBlock, Tensor, Uses xformers efficient implementation,     see https://github.com/MatthieuTPHR/
...
Cohesion: 0.60
Nodes (4): make_anaglyph_image(), make_anaglyph_video(), Copyright 2026 Google LLC  Licensed under the Apache License, Version 2.0 (the ", to_pil()

### Community 147 - "App Vendor Video Depth Anything (10)"
Cohesion: 0.17
Nodes (6): SpectralNormStateDictHook, NormalizeImage, PrepareForNet, Normlize image by given mean and std., Prepare sample for usage as network input., object

### Community 148 - "Previews Ab V5B"
Cohesion: 0.60
Nodes (4): cost_summary(), fetch(), main(), Generate the A/B cost reports from the live job records.  Reads jobs.tsv (label,

### Community 149 - "Scripts Smoke Test"
Cohesion: 0.70
Nodes (4): main(), report(), submit(), wait()

### Community 152 - "App Vendor ProPainter (23)"
Cohesion: 0.50
Nodes (4): get_hanning_kernel1d(), get_hanning_kernel2d(), r"""Returns Hanning (also known as Hann) kernel, used in signal processing and K, r"""Returns 2d Hanning kernel, used in signal processing and KCF tracker.      A

### Community 154 - "Scripts Make Samples"
Cohesion: 0.67
...
### Community 321 - "instantiate_from_config"
Cohesion: 0.24
...
### Community 322 - "DepthPanel.test.tsx"
Cohesion: 0.18
Nodes (16): encodeSceneOverrides(), ProfileShot, RawMessage, SceneOverride, profileShots(), bodyJSON(), Conversion, T (+8 more)

### Community 323 - "distributions.py"
Cohesion: 0.22
Nodes (4): AbstractDistribution, DiracDistribution, normal_kl(), source: https://github.com/openai/guided-diffusion/blob/27c20a8fab9cb472df5d6bdd

### Community 324 - "DeliverPanel.test.tsx"
Cohesion: 0.24
Nodes (7): Context, New(), AnalyzeMetadata, Client, ReuseLookup, SubmitResponse, UpstreamError

### Community 325 - "depthRes.ts"
Cohesion: 0.17
Nodes (6): Apply the block to a Tensor, conditioned on a timestep embedding.         :param, checkpoint(), CheckpointFunction, Evaluate a function without caching intermediate activations, allowing for     r, Tensor, selected_attn()

### Community 326 - "inpaint_window"
Cohesion: 0.26
Nodes (4): STEP_DEFS, stepDef, StepTab(), Step

### Community 327 - "DiagonalGaussianDistribution"
Cohesion: 0.17
Nodes (4): DiagonalGaussianRegularizer, Any, Tensor, DiagonalGaussianDistribution

### Community 328 - "EDMSampler"
Cohesion: 0.25
Nodes (3): EDMSampler, EulerEDMSampler, HeunEDMSampler

### Community 329 - "Resize"
Cohesion: 0.38
Nodes (3): Init.          Args:             width (int): desired output width             h, Resize sample to given size (width, height)., Resize

### Community 330 - "LinearAttention"
Cohesion: 0.33
Nodes (3): LinearAttention, LinAttnBlock, to match AttnBlock usage

### Community 331 - "FrozenOpenCLIPImageEmbedder"
Cohesion: 0.27
Nodes (10): currentTimeToFrame(), mediaTimeToFrame(), PreviewFrameMetadata, FPS24, FrameCallback, NTSC, renderPlayer(), usePreviewPlayer() (+2 more)

### Community 333 - "_make_infer"
Cohesion: 0.20
Nodes (10): _infer_da2(), _infer_da3(), _infer_depth_pro(), _make_infer(), transformers DA2-metric: returns depth in meters at the     working resolution., DA3 api: its InputProcessor handles resize (short side =     input_size via lowe, Apple Depth Pro: absolute metric depth in meters at the     working resolution,, Working resolution: short side = input_size, both multiples of     14 (same rule (+2 more)
...
Cohesion: 0.38
Nodes (4): Config, getenv(), Load(), eslintConfig

### Community 337 - "ClassifyChargeError"
Cohesion: 0.57
Nodes (6): ClassifyChargeError(), T, TestClassifyChargeErrorAPIOutageIsTransient(), TestClassifyChargeErrorAuthenticationRequired(), TestClassifyChargeErrorCardDeclined(), TestClassifyChargeErrorNonStripeIsTransient()

### Community 338 - "layout.tsx"
Cohesion: 0.33
Nodes (4): geistMono, geistSans, metadata, MswProvider()

### Community 342 - ".init_weights"
Cohesion: 0.50
Nodes (4): init_weights_vit_timm(), named_apply(), Module, ViT weight initialization, original timm impl (for reproducibility)

## Knowledge Gaps
- **423 isolated node(s):** `install.sh script`, `deploy.sh script`, `spatial-ai-labs/stereo3d-gateway`, `Service`, `Service` (+418 more)
...
- **Why does `_load_watchdog()` connect `ProPainter RAFT Utils` to `Gateway Internal Httpx`?**
  _High betweenness centrality (0.293) - this node is a cross-community bridge._
- **Why does `get_logger()` connect `Debug Logging & Error Handling` to `Storage & Analyze Pipeline`, `Gateway Internal Httpx`, `Slack Notify & Watchdog`, `App Vendor ProPainter (11)`, `Model Weights Management`, `App Stages Depth Pro`?**
...
- **Should `Debug Logging & Error Handling` be split into smaller, more focused modules?**
  _Cohesion score 0.09071117561683599 - nodes in this community are weakly interconnected._
- **Should `Web Project Cards & UI Kit` be split into smaller, more focused modules?**
