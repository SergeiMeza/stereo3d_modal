...
| 2026-09-01 | prod | 4a1bca4762d1 | stereo_preview · filled-fast (migan) | 3k | 4436@24 · 121 | $11.48¹ | 23 min | 12.1 min | $0.80 | $0.80 | 14.3× | First prod migan on the lite tier: stereo 6×~235 s L4 ($0.68), mvhevc 162 s, depth reused. Billed == stage estimate exactly — no cold-start overhead to speak of on L4 (vs +40% on the H200 tiers). ETA 1.9× over → anchors the eta-scale fix (migan ≈0.5, raw ≈0.35 of the residual) |

¹ (row 1) includes the (since removed) $0.50 analyze credit; (migan row) the charge itself was DECLINED (do_not_honor) — the run that exposed the missing download payment gate (fixed 2026-09-01, cc5024e). ² ~24 min of that was
